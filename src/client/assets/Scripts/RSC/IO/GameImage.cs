...
namespace Assets.RSC.IO
{
	...
	/* implements ImageProducer, ImageObserver */{
		...
		public void loadImage(int arg0, bool isSprite = false)
		{
			if (arg0 >= pictureColorIndexes.Length || pictureColorIndexes[arg0] == null)
				return;
			int i = pictureWidth[arg0] * pictureHeight[arg0];
			...
			if (isSprite)
				DataLoader.TryAddSprite(arg0);
			else
				DataLoader.TryAddIcon(arg0);
		}
		...
		public void drawEntity(int x, int y, int width, int height, int index)
		{
			...
			{
				Debug.Log("error in sprite clipping routine");
			}
		}
				...
				int arg14)
		{
			...
			{
				Debug.Log("error in transparent sprite plot routine");
			}
		}
		...
		public void drawFloatingText(String arg0, int arg1, int arg2, int arg3, int arg4, int arg5)
		{
			...
			{
				Debug.Log("centrepara: " + exception);
		...
		public void drawString(String arg0, int arg1, int arg2, int arg3, int arg4)
		{
					...
					for (int i = 0; i < arg0.Length; i++)
					{
						...
						if (arg0[i] == '@' && i + 4 < arg0.Length && arg0[(i + 4)] == '@')
						{
							if (arg0.Substring(i + 1, 3).ToLower().Equals("red"))
								...
								arg4 = 0xffffff;
							else if (arg0.Substring(i + 1, 3).ToLower().Equals("cameraDistanceZ"))
								arg4 = 0;
			...
			{
				Debug.Log("drawstring: " + exception);
				// exception.printStackTrace();
				return;
			}
		}
				...
				int arg7, int arg8)
		{
			...
			{
				Debug.Log("plotletter: " + exception);
				//exception.printStackTrace();
				return;
			}
		}
