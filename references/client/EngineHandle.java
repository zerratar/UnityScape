...
public class EngineHandle {
    ...
    public EngineHandle(Camera camera, GameImage gameImage) {
        ...
        try {
			landscape = new File(mudclient.DATA_DIR + "landscape");
            tileArchive = new ZipFile(landscape);
        } catch (Exception e) {
            e.printStackTrace();
        }
	...
	public boolean stepOverflow;
	public String overflowCorrectiveAction;
    public Model aModel;
